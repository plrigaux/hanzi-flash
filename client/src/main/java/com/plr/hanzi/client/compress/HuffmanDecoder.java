...
public class HuffmanDecoder {
	...
	public String decode(byte[] encodedData, HashMap<Character, String> huffEncodeTable, int rawDataLen) {
		...
		// decoded data.
		StringBuilder output = decodeStringBitsToCharacters();
		...
		output.setLength(rawDataLen);
		return output.toString();
	} // end decode method

	// -----------------------------------------------------//

	// The method begins with an empty StringBuilder object
	// referred to by the variable named workBuf and another
	// empty StringBuilder object referred to by the variable
	// named output. The StringBuilder object referred to by
	// output is used to construct the decoded message. The
	// StringBuilder object referred to by workBuf is used as
	...
	// character is read, it is appended to the StringBuilder
	// object referred to by workBuf.
	// As each new character is appended to the StringBuilder
	// object, a test is performed to determine if the
	// current contents of the StringBuilder object match one
	...
	// key is extracted and appended to the StringBuilder
	...
	// StringBuilder object is instantiated, referred to by
	...
	// point, the StringBuilder object referred to by output
	...
	StringBuilder decodeStringBitsToCharacters() {
